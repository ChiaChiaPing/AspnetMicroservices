...
namespace Discount.Grpc.Protos {
  public static partial class DiscountGrpcService
  {
    ...
    /// <summary>Base class for server-side implementations of DiscountGrpcService</summary>
    [grpc::BindServiceMethod(typeof(DiscountGrpcService), "BindService")]
    public abstract partial class DiscountGrpcServiceBase
    {
      /// <summary>
    ...
    public static grpc::ServerServiceDefinition BindService(DiscountGrpcServiceBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, DiscountGrpcServiceBase serviceImpl)
    {
